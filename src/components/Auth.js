...
export const Auth = (props) => {
  ...
  return ( 
    <div className="boxes w-full relative h-[100vh] flex justify-center items-center font-[poppins]">
      ...
      <button className='w-[5rem] h-60px top-4 bg-[#4b4e51] p-[5px] rounded-[8px] absolute right-4 font-semibold text-[#919495] duration-300 ' onClick={signInWithGoogle}>Login</button>
      </header>
      ...
      <button className='absolute w-[13rem] h-[50px] bg-[#4b4e51] top-[20rem] p-[5px] rounded-[12px] text-[18px]  font-semibold text-[#a3a7a8] duration-300  hover:shadow-[0px_0px_50px_0px_rgba(25,26,28)] hover:scale-105' onClick={signInWithGoogle}>Open in browser</button>
    </div>
  )
};
